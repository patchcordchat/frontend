<template>
  <div>
    ...
    <div class="p-modal__body p-modal__section">
      <p-button width="max" view="secondary" @click="nextStep">Для меня и друзей</p-button>

      <p-button width="max" view="secondary" @click="nextStep">Для клуба или сообщества</p-button>
    </div>
